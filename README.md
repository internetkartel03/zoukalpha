...
Zouk was originally started by [Cole Medin](https://www.youtube.com/@ColeMedin) but has quickly grown into a massive community effort to build the BEST open source AI coding assistant!
...
Zouk is a community effort! Still, the core team of contributors aims at organizing the project in way that allows
...
Let's get you up and running with the stable version of Zouk!

## Quick Installation

[![Download Latest Release](https://img.shields.io/github/v/release/stackblitz-labs/Zouk?label=Download%20Zouk&sort=semver)](https://github.com/stackblitz-labs/Zouk/releases/latest) ← Click here to go to the latest release version!
...
You have two options for running Zouk: directly on your machine or using Docker.
...
Zouk supports both methods for maximum flexibility:
...
1. **Clone the Repository**:
   ...
   ```bash
   git clone -b stable https://github.com/stackblitz-labs/Zouk.git
   ```
...
## 🔒 License: Metallic.v1 Proprietary

This software is **proprietary and confidential**. 

**Unauthorized access, use, modification, or distribution is strictly prohibited.**

### Access Requirements
- **License Fee**: $1,500 USD
- **Explicit Authorization**: Required from Metallic.v1
- **Single User**: Non-transferable, non-resalable
- **Confidential**: Cannot be shared, rebranded, or modified

### Restrictions
- ❌ No resale or redistribution
- ❌ No rebranding or claiming ownership
- ❌ No modifications or derivative works
- ❌ No commercial use without explicit consent
- ❌ No copying beyond single backup

For full terms, see [LICENSE](./LICENSE)

**By using this software, you acknowledge acceptance of the Metallic.v1 Proprietary License.**
